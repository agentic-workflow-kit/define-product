...
| Layer                  | Owns                                                                                             | Status  |
| ---------------------- | ------------------------------------------------------------------------------------------------ | ------- |
| [product/](./product/) | **What & why** — product overview, the define-product PRD, and the acceptance-criteria contract. | seeded  |
| [design/](./design/)   | **How** — the contract/seam technical design, its planner handoff, and enforcement gates.        | drafted |
